...
function changeGlass(direction)
{
    if(direction)
    {
        $("#glass").fadeOut('fast',()=>{$("#glass").attr("src","gray_Lupa.png"); $("#glass").fadeIn('fast')});
    }
    else
    {
        $("#glass").fadeOut('fast',()=>{$("#glass").attr("src","white_Lupa.png"); $("#glass").fadeIn('fast')});
    }
}

function expandSearchBar()
{
    $("#searchBar").css("display","auto")
}